...
export const TextArea = React.forwardRef<HTMLTextAreaElement, TextAreaProps>(
  ({ label, error, ...props }, ref) => (
    <div className="mb-4">
      ...
      <textarea
        ref={ref}
        className={`w-full px-4 py-2.5 bg-surface border rounded-xl text-sm text-on-surface font-medium placeholder:text-on-surface/50 outline-none transition-all resize-y min-h-[80px] ${
          error
